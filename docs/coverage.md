...
| no agent CLI at all                       | the board's checklist names both and offers no command, `tests/cockpit-guide.test.ts` and `e2e/cockpit.spec.ts`; looked at on 2026-07-28                                                                                                                                                                                                            | unit, browser      |
