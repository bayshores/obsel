...
Counts on 2026-07-26: 373 unit tests across 17 files, 174 python self-checks across 7 modules,
93 live tests across 10 files, 121 browser checks across two viewports. Live runs are single
