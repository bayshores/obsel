...
Counts on 2026-07-24: 298 unit tests across 14 files, 174 python self-checks across 7 modules,
76 live tests across 8 files, 121 browser checks across two viewports. Live runs are single
