...
import {
  ...
  rowsWritten,
  stampLabel,
} from "@/src/features/dashboard/progress";
import { clockTime } from "@/src/features/dashboard/timing";
...
describe("formatDuration", () => {
  ...
  it("refuses to format a negative or non-finite duration as a number", () => {
    // The same placeholder the dashboard uses for any withheld figure. It changed
