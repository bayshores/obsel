 ...
 *
 * `data` rather than `mine`, and `join` rather than `joining`: these are the
...
export function Tabs({
  ...
  return (
    <div className={styles.tabs} role="tablist" aria-label="What the dock is showing">
      {TABS.map((tab) => {
        ...
        return (
          ...
          >
            ...
            {selected && (
               ...
               * the dock's `LazyMotion` loads `domMax`: layout projection is
