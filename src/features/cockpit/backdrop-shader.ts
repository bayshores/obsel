/**
 * The cockpit's backdrop: hand-written GLSL on a bare WebGL context.
 *
 ...
 *
 * These are the only two colour literals in the whole cockpit that a `var()`
 ...
 * not an error path to recover from: the cockpit is completely legible with no
