...
export const TOUR: readonly TourStep[] = [
  ...
  },
  {
    ...
    body: "A box with a coloured bar down its left edge is an agent. A plain filled box is a table. The arrows show which tables each agent reads and writes. Click any box to see everything obsel holds about it.",
  },
  {
    id: "trace",
    chapter: 1,
