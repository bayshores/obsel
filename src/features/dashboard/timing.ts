 ...
 *
 * Pure, so every claim the dashboard makes about a measurement can be tested
...
/**
 * A wall-clock time, as every surface in the dashboard renders it.
 *
...
/**
 * The change the dashboard is currently talking about: the most recent mark.
 *
 ...
 * and the dashboard contradicts itself on screen with no indication which half is
 * right.
 *
