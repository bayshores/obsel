 ...
 *
 * Everything else in the dashboard is compressed to be readable at a glance and
 ...
 *
 * Neither depth computes a freshness, an age, or a "last seen": the dashboard
      ...
      {!preview && (
        <>
          ...
          {/*
            ...
            The read latency and the answered-at clock used to sit in the dashboard's
