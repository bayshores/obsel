 ...
 * every render from the same snapshot the rest of the dashboard is derived from,
 ...
 * folded panels in `your-data-panel.tsx`. Neither is ever consulted about the board.
 */
