...
Checked 2026-07-26: `pnpm verify` passes end to end, with 305 tests and 174 Python self-checks
across seven modules. `pnpm test:live` passes 78 tests across eight files in 267 s, two of
