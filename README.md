...
Checked 2026-07-26: `pnpm verify` passes end to end, with 373 tests and 174 Python self-checks
across seven modules. `pnpm test:live` passes 93 tests across ten files in 256 s, two of
