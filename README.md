...
Checked 2026-07-26: `pnpm verify` passes end to end, with 334 tests and 174 Python self-checks
across seven modules. `pnpm test:live` passes 84 tests across nine files in 260 s, two of
