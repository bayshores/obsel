  ...
  return [
    {
      ...
      phase: "read",
      message: "Read the swarm from DataHub.",
      outcome: "4 tasks",
    },
    {
      seq: 2,
      ...
      phase: "compare",
      message: "Compared clean orders against the fingerprint from last time.",
      outcome: "its columns changed; the values did not",
    },
    {
      seq: 3,
      at: "2026-07-22T09:00:00.200Z",
      phase: "walk",
      message: "Walked the lineage graph for finished work built on clean orders.",
      outcome: "3 affected: Daily revenue (1 hop), Revenue report (2 hops), Table docs (2 hops)",
    },
    {
      seq: 4,
      at: "2026-07-22T09:00:00.300Z",
      phase: "mark",
      message: "Marked Daily revenue out of date and tagged it in DataHub.",
      outcome: "1 hop · schema",
    },
    {
      seq: 5,
      at: "2026-07-22T09:00:00.400Z",
      phase: "done",
      message: "Finished deciding what the change affected.",
      outcome: "142 ms",
    },
  ];
}
